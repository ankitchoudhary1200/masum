...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
"https://github.com/ankitchoudhary1200/masum"),
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv(
    "GIT_TOKEN", None
)  # Fill this variable if your upstream repository is private

SUPPORT_CHANNEL = "SUPPORT_CHANNEL", "https://t.me/masoomupdate"

SUPPORT_CHAT = "https://t.me/masoomupdate"
...
votemode = {}
autoclean = []
confirmer = {}DURATION_LIMIT = int(time_to_seconds(f"{DURATION_LIMIT_MIN}:00"))
